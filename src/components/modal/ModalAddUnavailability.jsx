...
const ModalAddUnavailability = ({ createUnavailability }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Une indisponibilité se chevauche déjà avec cet intervalle.");
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <Button variant="link" className="py-0 text-destructive">
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              créer un créneau d'indisponibilité.
            </DialogDescription>
          </DialogHeader>
          <Popover>
...
export default ModalAddUnavailability;
